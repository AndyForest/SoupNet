...
3. **A real deficit on cross-event integration** (0.766 vs 0.827, n=423): tasks whose answers integrate many events favor having everything in context over top-k retrieval. The retrieval synthesis premium feature (`docs/planning/premium-llm-features.md`) is the designed response; its controlled test is queued.
